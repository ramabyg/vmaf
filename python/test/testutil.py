...
def set_default_576_324_yuv422p_videos_for_testing():
    ref_path = VmafConfig.test_resource_path(
        "yuv", "src01_hrc00_576x324_yuv422p.yuv")
    dis_path = VmafConfig.test_resource_path(
        "yuv", "src01_hrc01_576x324_yuv422p.yuv")
    asset = Asset(dataset="test", content_id=0, asset_id=0,
                  workdir_root=VmafConfig.workdir_path(),
                  ref_path=ref_path,
                  dis_path=dis_path,
...
def set_default_576_324_yuv444p_videos_for_testing():
    ref_path = VmafConfig.test_resource_path(
        "yuv", "src01_hrc00_576x324_yuv444p.yuv")
    dis_path = VmafConfig.test_resource_path(
        "yuv", "src01_hrc01_576x324_yuv444p.yuv")
    asset = Asset(dataset="test", content_id=0, asset_id=0,
                  workdir_root=VmafConfig.workdir_path(),
                  ref_path=ref_path,
                  dis_path=dis_path,
...
def set_default_576_324_yuv444p10le_videos_for_testing():
    ref_path = VmafConfig.test_resource_path(
        "yuv", "src01_hrc00_576x324_yuv444p10le.yuv")
    dis_path = VmafConfig.test_resource_path(
        "yuv", "src01_hrc01_576x324_yuv444p10le.yuv")
    asset = Asset(dataset="test", content_id=0, asset_id=0,
                  workdir_root=VmafConfig.workdir_path(),
                  ref_path=ref_path,
                  dis_path=dis_path,
                  asset_dict={'width': 576, 'height': 324,
                              'yuv_type': 'yuv444p10le'})
...
def set_default_576_324_yuv444p12le_videos_for_testing():
    ref_path = VmafConfig.test_resource_path(
        "yuv", "src01_hrc00_576x324_yuv444p12le.yuv")
    dis_path = VmafConfig.test_resource_path(
        "yuv", "src01_hrc01_576x324_yuv444p12le.yuv")
    asset = Asset(dataset="test", content_id=0, asset_id=0,
                  workdir_root=VmafConfig.workdir_path(),
                  ref_path=ref_path,
                  dis_path=dis_path,
                  asset_dict={'width': 576, 'height': 324,
                              'yuv_type': 'yuv444p12le'})
